...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=558695300401:+55 8695300401\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Tchau. @${num.split('@')[0]} Obrigado pela sua participação,você foi especial para nós! 💙`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					wait: '❬❗❭ Espere um instante,por gentileza',
					success: '️❬ ✔ ❭ Sucesso 🖤',
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓 BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓? Este é um recurso especial para o 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓 ❌',
					ownerB: '[❗] 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓? Este é um recurso especial para o 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓 ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓. Registre-se para fazer amizade com o bot 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓 por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓|17\n\n──「 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓 BOT 」──`,
			...
			const ownerNumber = ["558695300401@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"558695300401@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["558695300401@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["558695300401@s.whatsapp.net"]//ubah nomor lo
			const premium = ["558695300401@s.whatsapp.net","558296156440@s.whatsapp.net"] 
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("Em 5 segundos você será removido,começando a contagem...")
		}, 0)
	}
		...
		if (isGroupAdmins) return reply('Olá! Acabei de ver que você é admin,então não irei bani-lo por compartilhar link de grupo sem permissão,ok? 😉')
		client.updatePresence(from, Presence.composing)
		if (messagesC.includes("#izinadmin")) return reply("#izinadmin diterima")
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`link detectado ${sender.split("@")[0]} voce sera expulso deste grupo em 5 segundos,fique esperto!`)
		setTimeout( () => {
			client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		}, 5000)
		setTimeout( () => {
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("bot")){
            ...
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
				...
				if (messagesC.includes("𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓f.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓 BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓 domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓 ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓 ✨* 」\n*│+ wa.me/558695300401*╰──────*「 *𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓* 」*────*\n\n*_SE QUER SER ADMIN DO BOT 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓:*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
           ...
           case 'shitlist':
               ...
               break
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* 𝐓𝐄𝐒𝐋𝐀 𝐁𝐎𝐓\n*YOUTUBE:* https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g\n*WPP:* wa.me/+558695300401\n*INSTA:* @animexx_png\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
